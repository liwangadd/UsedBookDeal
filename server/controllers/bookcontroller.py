...
def release_book():
	try:
		...
		print 'user_id or username or bookname or price or type is None'
		return 'failed'
...
def set_book_info():
	try:
		...
		return 'failed'
	book_info = {}
	for key in (Book.BOOKNAME, Book.TYPE, Book.PRICE, Book.NEWNESS,
			Book.AUDIENCE, Book.DESCRIPTION, Book.MOBILE, Book.QQ,
			Book.WEIXIN):
		try:
